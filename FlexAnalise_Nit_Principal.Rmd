...
g1 <- casosNit_final |> ggplot(aes(x=date, y=`Casos novos`))+ 
...
g2 <- casosNit_final |> ggplot(aes(x=date, y=`Óbitos novos`))+ 
  geom_bar(stat="identity",
           fill="orange")+
  geom_line(aes(y=`Média móvel`),
            col="blue")+
...
g7 <- casosNit_final |> ggplot(aes(x=date, y=`Leitos clínicos ocupados`))+ 
  geom_bar(stat="identity",
           fill="white",
           col="orange")+
  geom_line(aes(y=`média móvel`),
...
g8 <- casosNit_final |> ggplot(aes(x=date, y=`Leitos UTI ocupados`))+
   geom_bar(stat="identity",
           fill="orange",
           col="orange")+
  geom_line(aes(y=`média móvel`),
...
g3 <- casosNit_final |> ggplot(aes(x=date, y=`Primeira dose`))+ 
  geom_bar(stat="identity",
           fill="orange")+
...
g4 <- casosNit_final |> ggplot(aes(x=date, y=`Vacinas aplicadas`))+ 
  geom_bar(stat="identity",
           fill="orange")+
  scale_x_date(date_breaks = "month",
               date_labels = "%b/%y")+
...
g5 <- casosNit_final |> ggplot(aes(x=date, y=`Vacinas aplicadas`))+ 
  geom_bar(stat="identity",
           fill="red")+
  scale_x_date(date_breaks = "month",
               date_labels = "%b/%y")+
...
g11 <- casosNit_final |> ggplot(aes(x=date, y=`Vacinas aplicadas`))+ 
  geom_bar(stat="identity",
           fill="red")+
  scale_x_date(date_breaks = "month",
               date_labels = "%b/%y")+
  scale_y_continuous(label = scales::label_number(big.mark = ".",
                                                  decimal.mark = ",")) +
  labs(title="Aplicação diária de Vacinas de 3ª Dose ou Dose Única", y= "Vacina de 3ª Dose ou Dose Única",
       x= "data")+ 
  theme_tufte()+
  theme(plot.title = element_text(hjust = 0.5, size=12, face="bold"),
        text = element_text(size=15))
...
g6 <- casosNit_final2 |> 
  ggplot(aes(x=date, y=`Aplicações primeira dose`, fill = "Primeira dose"))+ 
  geom_line(col= "red")+
